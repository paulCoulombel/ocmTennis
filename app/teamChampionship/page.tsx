...
export default function HomePage() {
  ...
  return (
    <div className="relative mx-auto bg-neutral-900 flex flex-col items-center overflow-hidden rounded-md">
      <div className="relative pb-20 min-h-screen h-full bg-neutral-900 w-full">
        <HeaderSection />
    ...
    <>
      ...
      <div className="hidden md:block pt-35 md:pt-40 md:pb-10 relative">
        <div className="z-10 w-full flex items-center justify-center h-60 relative mt-3 mb-5">
          ...
          <div className="pointer-events-none w-full h-full absolute top-0 bg-linear-to-t from-transparent via-transparent to-neutral-900 blur-sm z-12"></div>
          <div className="pointer-events-none w-full h-full absolute top-0 bg-linear-to-b from-transparent via-transparent to-neutral-900 blur-sm z-12"></div>
      ...
      <div className="md:hidden pt-25">
        <div className="w-full h-60 relative mt-3 mb-5">
          ...
          {/* Core component */}
          <div className="pointer-events-none w-full h-full absolute top-0 bg-linear-to-t from-transparent via-transparent to-neutral-900 blur-sm z-19"></div>
          <div className="pointer-events-none w-full h-full absolute top-0 bg-linear-to-b from-transparent via-transparent to-neutral-900 blur-sm z-19"></div>
          <SparklesCore
            background="transparent"
            minSize={0.8}
            maxSize={1.5}
...
const CurrentSeasonComponent = () => {
  ...
  return (
    <div className="pointer-events-auto z-10 mx-auto w-full max-w-130 bg-[#0c7e3a] relative rounded-2xl overflow-hidden">
      <div className="relative h-full bg-[radial-gradient(88%_100%_at_top,rgba(255,255,255,0.5),rgba(255,255,255,0))]  sm:mx-0 sm:rounded-2xl overflow-hidden">
...
const StatistiquesComponent = ({
  ...
  return (
    <div className="mx-auto w-full bg-[#a4b03d] relative rounded-2xl overflow-hidden">
      <div className="relative  h-full text-white bg-[radial-gradient(88%_100%_at_top,rgba(255,255,255,0.5),rgba(255,255,255,0))]  sm:mx-0 sm:rounded-2xl overflow-hidden">
...
const BlinkingCircles = () => {
  ...
  return (
    ...
    >
      <span className="absolute inset-0 rounded-full bg-linear-to-br from-[#fff6c8]/50 via-[#ffffe0]/50 to-[#e3c671]/50 opacity-50 shadow-[0_0_18px_rgba(255,246,200,0.5)]" />
...
const FirstSection = ({ windowWidth }: { windowWidth: number }) => {
  ...
  if (isLoading) {
    return (
      <div className="flex gap-6 w-full px-10 flex-col">
  ...
  return (
    <div className="z-10 flex gap-6 w-full px-10 h-full flex-col">
...
const TableSection = ({
  ...
  useEffect(() => {
    ...
    setDayNumber(
      tableTeams
        ? tableTeams
            .filter((t) => t.name.includes('G 17/18'))[0]
            .matchResults.reduce(
              (acc, curr) =>
  ...
  return (
    <div className="relative flex flex-col bg-linear-to-b from-indigo-900/50 via-indigo-900 to-blue-900 py-15 w-full px-3 min-h-screen">
      {windowWidth >= 425 && (
        <FlowerCanvas
          firstFlowersPointer={[
            { x: 0.1, y: 0.3 },
...
const NextMatchesSection = ({
  ...
  const [nextMatchesIndex, setNextMatchesIndex] = React.useState(1)
  useEffect(() => {
    const saved = sessionStorage.getItem('teamChampionship_nextMatchesIndex')
    setNextMatchesIndex(saved ? parseInt(saved, 10) : 1)
  }, [])
  const router = useRouter()
  let matchHomeCount = 0
  ...
  if (nextMatches.length === 0) {
    return (
      <div className="relative flex flex-col bg-linear-to-b from-[#e3c671]/70 via-[#e3c671] to-[#e3c671]/80 pt-15 pb-15 w-full px-3">
        {windowWidth >= 425 && (
          <FlowerCanvas
            firstFlowersPointer={[
              { x: 0.06, y: 0.6 },
        ...
        <div className="relative mx-auto container max-w-260 bg-[#6b5e39] border border-[#6b5e39]/50 rounded-2xl pt-10 z-20">
          ...
          <div className="pointer-events-none relative pt-20 pb-10 z-20">
            <div className="absolute left-1/2 top-0 bottom-0 w-1 bg-linear-to-b from-white/20 via-white/40 to-white/20 transform -translate-x-1/2 h-60"></div>
        ...
        <div className="">
          <h4 className="text-2xl font-bold">
            {(() => {
              ...
              if (dayName === 'dimanche') {
                return (
                  'Week-end du ' + format(dateObj, 'dd MMMM', { locale: fr })
                )
              }
              return format(dateObj, 'EEEE dd MMMM', {
                locale: fr
  ...
  const wheelPickerOptions = [
    {
      label: (
        <div className="">
          <h4 className="text-2xl font-bold">
            {(() => {
              const dateObj = subDays(groupedData[0].date, 7)
              const dayName = format(dateObj, 'EEEE', { locale: fr })
              if (dayName === 'dimanche') {
                return (
                  'Week-end du ' + format(dateObj, 'dd MMMM', { locale: fr })
  ...
  return (
    <div className="pt-5 pb-25 relative flex flex-col bg-linear-to-b from-[#e3c671]/70 via-[#e3c671] to-[#e3c671]/80 w-full px-3">
      {windowWidth >= 1024 && (
        <FlowerCanvas
          ...
          <WheelPickerWrapper className="pointer-events-auto bg-[#6b5e39] border-none">
            <WheelPicker
              ...
              onValueChange={(value) => {
                ...
                setNextMatchesIndex(newValue)
                sessionStorage.setItem(
                  'teamChampionship_nextMatchesIndex',
                  newValue.toString()
                )
              }}
              classNames={{
              ...
              defaultValue={nextMatchesIndex + 1}
              visibleCount={8}
            />
          </WheelPickerWrapper>
        </div>
          ...
          >
            {groupedData[nextMatchesIndex].matches.map((match, index) => {
              ...
              return (
                <NextMatchCard
                  match={match}
                  matchHomeCount={matchHomeCount}
                  delay={groupedData[nextMatchesIndex].matches.length - index}
                  key={`${match.date}-${index}`}
                  onClick={() => redirectToPoolPage(match.poolId)}
                />
              )
            })}
          </motion.div>
...
const NextMatchCard = ({
  ...
  return (
    <motion.div
      ...
      className={cn(
        'group relative w-full overflow-hidden rounded-2xl max-w-130 mx-auto pointer-events-auto hover:cursor-pointer',
        'bg-linear-to-br from-[#6b5e39]/95 via-[#524932]/90 to-[#4a4128]/90 backdrop-blur-md',
    ...
    >
      ...
      <div className="absolute inset-0 bg-linear-to-r from-transparent via-[#ffffe0]/3 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
      ...
      <div className="relative p-5 pb-0">
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-3">
            <div
              className={`relative p-2.5 rounded-xl transition-all duration-300 ${
                match.isHome
                  ? 'bg-linear-to-r from-green-700/30 to-emerald-700/30 text-green-300 group-hover:from-green-700/40 group-hover:to-emerald-700/40'
                  : 'bg-linear-to-r from-[#ffffe0]/20 to-[#e3c671]/20 text-[#ffffe0] group-hover:from-[#ffffe0]/30 group-hover:to-[#e3c671]/30'
              }`}
            >
              <div
            ...
            <div className="flex flex-col">
              ...
              <span className="text-xs text-[#e3c671]/80">
                {match.isHome
                  ? matchHomeCount < 3 || match.category === 'Jeunes'
                    ? 'Salle Louis Darcel'
                    : 'Salle Délisse'
                  : 'Déplacement'}
              </span>
          ...
          <div className="flex flex-row gap-2 items-center">
            {match.isLate && (
              <Badge className="py-1 px-2 h-6 text-[#ffffe0]/90 bg-red-700/80 border-none">
                Match en retard
              </Badge>
            )}
            <div className="relative">
              <div className="absolute inset-0 bg-linear-to-r from-[#e3c671] to-[#ffffe0] rounded-lg blur-sm opacity-50 group-hover:opacity-75 transition-opacity" />
              <div className="font-bold text-md relative bg-linear-to-r from-[#e3c671]/95 to-[#ffffe0]/95 text-[#524932] px-3 py-2 rounded-lg backdrop-blur-sm border border-[#ffffe0]/20">
      ...
      <div className="relative px-5 pb-4">
        <div className="mb-4">
          ...
          <div className="text-sm font-semibold text-[#ffffe0]/80 bg-[#524932]/90 px-2 py-1 rounded-md inline-block border border-[#6b5e39]">
            {match.division}
          </div>
        </div>
        ...
        <div className="relative">
          <div className="absolute left-0 top-1/2 -translate-y-1/2 w-8 h-px bg-linear-to-r from-[#e3c671] to-orange-400" />
      ...
      <div className="absolute bottom-0 left-0 right-0 h-1">
        <div className="h-full bg-linear-to-r from-[#6b5e39] via-[#e3c671] to-[#ffffe0] opacity-60 group-hover:opacity-100 transition-opacity duration-300" />
        <div className="absolute top-0 left-0 h-full w-full bg-linear-to-r from-transparent via-[#ffffe0]/20 to-transparent -translate-x-full group-hover:translate-x-full transition-transform duration-1000 ease-in-out" />
      </div>
