...
export default function FilterHeaderCheckbox({
  ...
  useEffect(() => {
    const saved = localStorage.getItem('tableTeamFilter')
    const newSelectedValues = saved ? JSON.parse(saved) : defaultValues
  ...
  const handleToggle = (value: string) => {
    ...
    setSelectedValues(newSelectedValues)
    column.setFilterValue(newSelectedValues)
    localStorage.setItem('tableTeamFilter', JSON.stringify(newSelectedValues))
  }
      ...
      <DropdownMenuTrigger asChild>
        <Button
          ...
          className={clsx(
            ...
            'bg-linear-to-r from-neutral-800 to-neutral-700 hover:from-neutral-700 hover:to-neutral-600',
